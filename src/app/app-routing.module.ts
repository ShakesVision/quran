...
const routes: Routes = [
  ...
  // Browse - Juz/Surah grid selector
  {
    path: "browse",
    loadChildren: () =>
      import("./pages/juz/juz.module").then((m) => m.JuzPageModule),
  },
  ...
  // Full Quran reader
  {
    path: "quran",
    loadChildren: () =>
      import("./pages/read/read.module").then((m) => m.ReadPageModule),
    data: { mode: "full" },
  },
  {
  ...
  },
  {
    path: "surahs",
    loadChildren: () =>
      import("./pages/surah/surah.module").then((m) => m.SurahPageModule),
  },
  {
    path: "surahs/:id",
    loadChildren: () =>
      import("./pages/surah-details/surah-details.module").then(
        (m) => m.SurahDetailsPageModule,
      ),
  },
  ...
  },
  {
    path: "memorize",
    loadChildren: () =>
      import("./pages/memorize/memorize.module").then(
        (m) => m.MemorizePageModule,
      ),
  },
  {
    path: "progress",
  ...
  },
  {
    path: "scanned",
    loadChildren: () =>
      import("./pages/scanned/scanned.module").then((m) => m.ScannedPageModule),
  },
  {
  ...
  },
  {
    path: "morphology",
    loadChildren: () =>
      import("./pages/morphology/morphology.module").then(
        (m) => m.MorphologyPageModule,
      ),
  },
  {
    path: "tajweed",
    loadChildren: () =>
      import("./pages/tajweed/tajweed.module").then((m) => m.TajweedPageModule),
  },
  {
    path: "privacy",
    loadChildren: () =>
