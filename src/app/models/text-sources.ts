...
export const TEXT_SOURCES: TextSource[] = [
  {
    ...
    baseUrl: 'https://raw.githubusercontent.com/ShakesVision/quran-archive/master/qurancom/comprehensive-15Lines',
    description: 'Quran.com IndoPak text (comprehensive) from archive',
    isDefault: true,
  ...
  },
  {
    ...
    linesPerPage: 16,
    fontFamily: 'IndoPak Waqf Lazim',
    baseUrl: 'https://raw.githubusercontent.com/ShakesVision/quran-archive/master/qurancom/comprehensive-16Lines',
    description: 'Quran.com IndoPak text (comprehensive) - 16 line version',
    supportsWordTracking: true,
  },
  {
    ...
    baseUrl: 'https://raw.githubusercontent.com/ShakesVision/quran-archive/master/qurancom/comprehensive-15Lines',
    description: 'Uthmani script sourced from comprehensive Quran.com data',
    supportsWordTracking: true,
  },
  {
    id: 'archive-15',
